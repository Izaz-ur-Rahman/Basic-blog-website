        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link <?php ($page == "index")? 'active' : ''; ?>" href="index.php">Home <span
                ...
                <a class="nav-link <?php ($page == "login")? 'active' : ''; ?>" href="login.php">Login</a>
                </li>
            ...
            <form class="d-flex " action="search.php" method="GET">
                <input class="form-control me-sm-2" type="search" placeholder="Search" name="keyword" Required
                    maxlength="70" autocomplete="off" value="<?= $keyword ?>" aria-label="Search">
