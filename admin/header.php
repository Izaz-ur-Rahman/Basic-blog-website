<?php
ob_start();
define('blog',true);     // define a constant
include "../config.php";
session_start();
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
            if (isset($_SESSION['user_data'])) {
                $admin = $_SESSION['user_data']['2']; // hum nai login.php mai user_data mai index [2] py role store ki hai that's why edher ye index use ki bs that's set
            }
            if($admin == 1)
            {   // to show all contents  agr admin login hua hai otherwise all contents show naa kary
